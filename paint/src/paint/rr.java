...
public class rr
{
    ...
    public rr()
    {
        f=new MyFrame("Граический редактор");
        f.setSize(350,350);
        ...
        Action loadAction = new  AbstractAction("Открити")
        {
            public void actionPerformed(ActionEvent event)
            {
                ...
                if(result==JFileChooser.APPROVE_OPTION)
                {
                    try
                    {
                        ...
                        JOptionPane.showMessageDialog(f, "Виняток введення-виведення");
                    }
                    catch (Exception ex) {
                    }
                }
        ...
        Action saveAction = new  AbstractAction("Зберегти")
        {
            public void actionPerformed(ActionEvent event)
            {
                ...
                {
                    JOptionPane.showMessageDialog(f, "Помилка введення-виведення");
                }
            }
        };
